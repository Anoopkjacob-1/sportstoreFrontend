...
export default function Productdetails(props) {
  ...
  // if(formik.values.categoreydrop && formik.values.branddrop)
  //   {
  //    const  subcatvalue =async()=>{
  //     try {
  // await axios.post( "http://localhost:5000/product/subcategoreyGetOne",{cat:formik.values.categoreydrop,brand:brand.formik.values.branddrop}).then((resp) => {
  ...
  const validationSchema = Yup.object({
    ...
    //   "fileSize",
    //   "File too large",
    //   value => { return value && value[0].size <= 200000 }
    // )
    // .test(
    //   "fileFormat",
    //   "Unsupported Format",
